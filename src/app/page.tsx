...
const MovieCard = React.lazy(() => import('@/app/ui/MovieCard'));
    ...
    <main className="container mx-auto flex min-h-screen flex-col items-center">
      ...
      <section>
        <div className="sm:grid grid-cols-5 grid-rows-1 px-4 py-6 min-h-full space-y-6 sm:space-y-0 sm:gap-4">
          <div className="h-96 col-span-4 bg-gradient-to-tl from-cyan-400 via-cyan-600 to-cyan-500 rounded-md flex items-center">
            <div className="mx-20">
              <h2 className="text-white  text-5xl">DESCUBRE EL UNIVERSO DEL CINE</h2>
              <p className="text-indigo-100 mt-4 font-thin tracking-wider leading-8 text-lg">Bienvenido a Películas Insight, tu portal para explorar, descubrir y sumergirte en el mundo de las películas. Encuentra información detallada, reseñas y mucho más, todo en un solo lugar.</p>
              <a href="#" className="uppercase inline-block mt-8 text-sm bg-white py-2 px-4 rounded font-semibold hover:bg-indigo-100">Saber más</a>
            </div>
          </div>
          <div className="h-96 col-span-1">
            ...
            <div className="bg-white rounded-md">
              <h1 className="text-center text-xl mt-8 bg-white py-2 rounded-md border-b-2 cursor-pointer text-gray-600">Categorias Top</h1>
              <ul className="bg-white rounded-md list-none text-center">
                {randomGenres.map((genre) => (
                  <li key={genre.id} className="py-3">
      ...
      <section className=" w-full py-6 px-4">
        <div className="container mx-auto">
          <h2 className="text-center text-3xl font-semibold capitalize flex  space-x-2">
